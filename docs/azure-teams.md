...
1. On the VM, copy `/etc/agent-relay/agentr-teams.zip` (or scp to your PC).
2. Teams → Apps → Manage your apps → **Upload a custom app** → upload the zip.
3. Open a **1:1 chat** with **AgentR**.

If you regenerate the zip after changing App ID or icons, remove the old app and upload again (manifest version bumps help).
